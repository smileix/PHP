...
class DataProcessor:
    ...
    def get_train_examples(self, data_dir: Optional[str] = None, domain=None, use_true_bio_label=False) -> List[InputExample]:
        """
        ...
        if domain is not None:
            return self.get_examples(data_dir, "train", domain, use_true_bio_label)
        return self.get_examples(data_dir, "train")

    def get_dev_examples(self, data_dir: Optional[str] = None, domain=None, use_true_bio_label=False) -> List[InputExample]:
        """
        ...
        """
        if domain is not None:
            return self.get_examples(data_dir, "dev", domain, use_true_bio_label)
        return self.get_examples(data_dir, "dev")

    def get_test_examples(self, data_dir: Optional[str] = None, domain=None, use_true_bio_label=False) -> List[InputExample]:
        """
        ...
        """
        if domain is not None:
            return self.get_examples(data_dir, "test", domain, use_true_bio_label)
